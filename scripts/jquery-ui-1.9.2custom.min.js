...
(function(t, e) {
    ...
    t.ui = t.ui || {};
    var n, a = Math.max, o = Math.abs, r = Math.round, l = /left|center|right/, h = /top|center|bottom/, c = /[\+\-]\d+%?/, u = /^\w+/, d = /%$/, p = t.fn.position;
    t.position = {
        scrollbarWidth: function() {
            if (n !== e)
                return n;
            var i, s, a = t("<div style='display:block;width:50px;height:50px;overflow:hidden;'><div style='height:100px;width:auto;'></div></div>"), o = a.children()[0];
        ...
        e = t.extend({}, e);
        var n, d, f, g, m, v = t(e.of), _ = t.position.getWithinInfo(e.within), b = t.position.getScrollInfo(_), y = v[0], w = (e.collision || "flip").split(" "), k = {};
        return 9 === y.nodeType ? (d = v.width(), f = v.height(), g = {
            ...
            var l, h, c = t(this), u = c.outerWidth(), p = c.outerHeight(), y = s(this, "marginLeft"), D = s(this, "marginTop"), x = u + y + s(this, "marginRight") + b.width, C = p + D + s(this, "marginBottom") + b.height, M = t.extend({}, m), I = i(k.my, c.outerWidth(), c.outerHeight());
            "right" === e.my[0] ? M.left -= u : "center" === e.my[0] && (M.left -= u / 2), "bottom" === e.my[1] ? M.top -= p : "center" === e.my[1] && (M.top -= p / 2), M.left += I[0], M.top += I[1], t.support.offsetFractions || (M.left = r(M.left), M.top = r(M.top)), l = {
                ...
                var i = g.left - M.left, s = i + d - u, n = g.top - M.top, r = n + f - p, l = {
                    target: {
                        element: v,
                        left: g.left,
                        top: g.top,
        ...
        flip: {
            left: function(t, e) {
                var i, s, n = e.within, a = n.offset.left + n.scrollLeft, r = n.width, l = n.isWindow ? n.scrollLeft: n.offset.left, h = t.left - e.collisionPosition.marginLeft, c = h - l, u = h + e.collisionWidth - r - l, d = "left" === e.my[0]?-e.elemWidth : "right" === e.my[0] ? e.elemWidth : 0, p = "left" === e.at[0] ? e.targetWidth : "right" === e.at[0]?-e.targetWidth : 0, f =- 2 * e.offset[0];
            ...
            top: function(t, e) {
                var i, s, n = e.within, a = n.offset.top + n.scrollTop, r = n.height, l = n.isWindow ? n.scrollTop: n.offset.top, h = t.top - e.collisionPosition.marginTop, c = h - l, u = h + e.collisionHeight - r - l, d = "top" === e.my[1], p = d?-e.elemHeight : "bottom" === e.my[1] ? e.elemHeight : 0, f = "top" === e.at[1] ? e.targetHeight : "bottom" === e.at[1]?-e.targetHeight : 0, g =- 2 * e.offset[1];
    ...
    t.effects = {
        ...
        function n(t) {
            ...
            return t = t.toLowerCase(), g(c, function(e, a) {
                var o, r = a.re.exec(t), l = r && a.parse(r), c = a.space || "rgba";
        ...
        var o, r = "backgroundColor borderBottomColor borderLeftColor borderRightColor borderTopColor color columnRuleColor outlineColor textDecorationColor textEmphasisColor".split(" "), l = /^([\-+])=\s*(\d+\.?\d*)/, c = [{
        ...
        f.style.cssText = "background-color:rgba(1,1,1,.5)", p.rgba = f.style.backgroundColor.indexOf("rgba")>-1, g(d, function(t, e) {
            ...
            parse: function(a, r, l, c) {
                ...
                var u = this, p = e.type(a), f = this._rgba = [];
            ...
            transition: function(t, e) {
                var i = h(t), n = i._space(), a = d[n], o = 0 === this.alpha() ? h("transparent"): this, r = o[a.cache] || a.to(o._rgba), l = r.slice();
            ...
            blend: function(t) {
                if (1 === this._rgba[3])
                    return this;
                var i = this._rgba.slice(), s = i.pop(), n = h(t)._rgba;
            ...
            var e, i, s = t[0] / 255, n = t[1] / 255, a = t[2] / 255, o = t[3], r = Math.max(s, n, a), l = Math.min(s, n, a), c = r - l, h = r + l, d = .5 * h;
            ...
            if (null == t[0] || null == t[1] || null == t[2])
                return [null, null, null, t[3]];
            var e = t[0] / 360, i = t[1], s = t[2], n = t[3], o = .5 >= s ? s * (1 + i): s + i - s * i, r = 2 * s - o;
            ...
            h.fn[t] = function(t) {
                if (r&&!this[o] && (this[o] = r(this._rgba)), t === i)
                    return this[o].slice();
                var n, l = e.type(t), d = "array" === l || "object" === l ? t: arguments, u = this[o].slice();
                ...
                h.fn[i] || (h.fn[i] = function(n) {
                    var a, o = e.type(n), r = "alpha" === i ? this._hsla ? "hsla": "rgba": t, c = this[r](), h = c[s.idx];
        ...
        function i() {
            var e, i, s = this.ownerDocument.defaultView ? this.ownerDocument.defaultView.getComputedStyle(this, null): this.currentStyle, n = {};
            if (s && s.length && s[0] && s[s[0]])
                for (i = s.length; i--;)
                    e = s[i], "string" == typeof s[e] && (n[t.camelCase(e)] = s[e]);
            else 
                for (e in s)
        ...
        t.each(["borderLeftStyle", "borderRightStyle", "borderBottomStyle", "borderTopStyle"], function(e, i) {
            ...
            return this.queue(function() {
                var a, o = t(this), r = o.attr("class") || "", c = l.children ? o.find("*").andSelf(): o;
                c = c.map(function() {
                    var e = t(this);
                    return {
                        el: e,
        ...
        t.extend(t.effects, {
            ...
            restore: function(t, i) {
                ...
                for (a = 0; i.length > a; a++)
                    null !== i[a] && (n = t.data(s + i[a]), n === e && (n = ""), t.css(i[a], n))
            },
            ...
            effect: function() {
                function e(e) {
                    ...
                    var n = t(this), a = s.complete, o = s.mode;
                    (n.is(":hidden") ? "hide" === o : "show" === o) ? i() : r.call(n[0], s, i)
                }
                var s = n.apply(this, arguments), a = s.mode, o = s.queue, r = t.effects.effect[s.effect], l=!r && i && t.effects[s.effect];
            ...
            toggle: function(e) {
                if (a(e) || "boolean" == typeof e || t.isFunction(e))
